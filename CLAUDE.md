...
- Use the `/kanban-markdown` skill or read `../kanban/features/` for current status and priorities
- Update feature file status in `../kanban/features/` as you complete tasks, add entries to `../changelog.md`
